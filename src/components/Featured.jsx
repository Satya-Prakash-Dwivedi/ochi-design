        ...
        <div className='px-20'>
            <div className='cards w-full flex gap-10 mt-10'>
                ...
                className='cardcontainer relative w-1/2 h-[75vh]  '>
                  <h1 className='absolute flex overflow-hidden  text-[#CDEA68] right-0 translate-x-1/2 top-1/2 -translate-y-1/2  z-[9] leading-none text-7xl tracking-tighter '>
                ...
                className='cardcontainer relative w-1/2 h-[75vh]'>
                <h1 className='absolute flex overflow-hidden text-[#CDEA68] right-full translate-x-1/2 top-1/2 -translate-y-1/2  z-[9] leading-none text-7xl tracking-tighter '>
