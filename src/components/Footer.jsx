...
function Footer() {
  return (
    <div className='w-full h-screen flex gap-5 bg-zinc-900 p-20 font-["Founders_Grotesk_X-Condensed"]'>
        <div className=' w-1/2 h-full flex flex-col justify-between font-semibold '>
            ...
            <h1 className=' text-[8vw] font-semibold uppercase leading-none -mt-8 '>opening</h1>
            </div>
        ...
        <div className=' w-1/2 '>
            ...
            <div className='text-xl font-["Neue_Montreal"] mt-10'> S.
                <a className='block font-light ' href="#">Facebook</a>
                <a className='block font-light ' href="#">Instagram</a>
                <a className='block font-light ' href="#">Twitter</a>
            </div>
            <div className='flex gap-36'>
            <div className='w-1/2 font-["Neue_Montreal"] mt-10'>L.
                <a href="#" className='block  font-light ' > 202-1965 W 4th Ave
                Vancouver, Canada
                </a>
                <a href="#" className='block  font-light mt-6' >30 Chukarina St
                Lviv, Ukraine </a>
            </div>
            <div className='w-1/2 font-["Neue_Montreal"] mt-10'>M.
                 <a className='block font-light' href="">Home</a>
                <a className='block font-light' href="">Services</a>
                <a className='block font-light' href="">Our work</a>
                <a className='block font-light' href="">About us</a>
                <a className='block font-light' href="">Insights</a>
                <a className='block font-light' href="">Contact us</a>
            </div>
            </div>
            <div className=' font-["Neue_Montreal"] mt-10'>E.
            <a href="#" className='block font-light '>hello@ochidesign.com</a>
        </div>
        </div>
    </div>
  )
